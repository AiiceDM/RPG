...
function Drakan() {
  return <>
    ...
    <HerancaCard
      ...
      sing2={<>Voz da Miragem — Você aprende o truque mágico <em>Figment</em> como magia arcana inata, podendo lançá-lo à vontade. Ao contrário do normal, você pode conjurá-lo gastando apenas <strong>1 Ação</strong> em vez de 2. O truque ganha o traço <strong>Flourish</strong>.</>}
      sing3={<>
