...
function Drakan() {
  return <>
    ...
    <HerancaCard
      ...
      sing1={<>Treinado em <strong>Diplomacia (Diplomacy)</strong>.</>}
      sing2={<><strong>Luz Purificadora</strong> (1 Ação) [Drakan, Luz] — <em>Frequência:</em> Uma vez a cada 1 hora. Você irradia um pulso de luz restauradora de Aurene. Escolha você mesmo ou um aliado dentro de <strong>9 metros (30 pés)</strong>: reduza em <strong>1</strong> o valor de uma das seguintes condições no alvo: <strong>Frightened</strong>, <strong>Sickened</strong>, <strong>Clumsy</strong>, <strong>Enfeebled</strong> ou <strong>Stupefied</strong>. Se a condição alvo tiver uma duração superior a <strong>1 dia</strong>, você deve realizar um teste de <strong>Counteract</strong> contra o efeito. Em um <strong>sucesso</strong>, a condição é reduzida normalmente; em uma <strong>falha</strong>, a condição não é reduzida e Luz Purificadora fica indisponível até suas <strong>próximas preparações diárias</strong>.</>}
      sing3={<>
