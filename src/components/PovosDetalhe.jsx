...
function IdiomaPadrao() {
  return <>
    <h2>Idiomas</h2>
    <p>Você conhece o <strong>Tyrian</strong> e um número adicional de idiomas igual a <strong>1 + metade do modificador de Inteligência (mín. 1)</strong>.</p>
  </>;
}
...
function Charr() {
  return <>
    ...
    <div className="povo-secao-flex">
      ...
      <div className="povo-img-placeholder">⚔️</div>
    </div>
