...
- List/detail pairs share a pattern: `Povos.jsx`↔`PovosDetalhe.jsx`, `Divindades.jsx`↔`DivindadesDetalhe.jsx`, `Capitais.jsx`↔`CapitalDetalhe.jsx`, `TalentosHabilidades.jsx`↔`TalentosDetalhe.jsx`. Lists navigate by id strings; detail pages resolve them through local data objects or `COMPONENTES` maps.
